                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            @if ($employee->original_filename)
                                ...
                                <a href="{{ route('delete-public-file', ['employeeId' => $employee->id]) }}" class="btn btn-danger btn-sm mt-2" onclick="return confirm('Apakah Anda yakin ingin menghapus CV ini?')">
